...
# change port
sed -i .bak  "s/create_empty_blocks = true/create_empty_blocks = false/g" $ETHCONFIG
sed -i .bak "s/26657/$COSMOSPORT1/g" $CLIENTCONFIG
sed -i .bak "s/26657/$COSMOSPORT1/g" $ETHCONFIG
sed -i .bak "s/26656/$COSMOSPORT0/g" $ETHCONFIG
sed -i .bak "s/9090/$GRPCPORT0/g" $APPCONFIG
sed -i .bak "s/9091/$GRPCPORT1/g" $APPCONFIG
sed -i .bak "s/8545/$ETHPORT0/g" $APPCONFIG
sed -i .bak "s/8546/$ETHPORT1/g" $APPCONFIG
sed -i .bak "s/aphoton/$DENOM/g" $APPCONFIG
